  ...
  return (
    <div className="HeroSection w-full min-h-screen flex flex-col-reverse md:flex-row justify-center items-center gap-10  bg-gradient-to-bl from-white to-blue-200">
        <div className="left w-full md:p-10 p-4 relative bottom-10">
            ...
            <button className="border-1 rounded-xl px-3 py-2 md:px-5 md:py-2   md:font-bold cursor-pointer bg-gray-800 text-white">GET STARTED TODAY</button>

            <button className="border-1 rounded-xl px-3 py-2 md:px-5 md:py-2 font-bold cursor-pointer ">CONTACT US</button>
            </div>
        </div>
