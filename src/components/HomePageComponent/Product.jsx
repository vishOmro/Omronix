...
const Product = () => {
  return (
    ...
    <div className="cardSection flex justify-center flex-wrap w-full md:px-20 px-2 gap-10 md:text-base text-sm">
         ...
         <ProductCard name={"Blockchain Solution"} link={"/product/blockchainsolution"} image={"/serv2.png"} overview={"Build trust, security, and efficiency with Omronix. Our end-to-end blockchain development and consulting services empower businesses with transparent, secure, and scalable solutions for seamless digital transformation."}/>
