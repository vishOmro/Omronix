  ...
  return (
     <div className="HeroSection w-full min-h-screen flex justify-center items-center gap-10">
            <div className="left w-full p-10 relative bottom-10">
                ...
                <p className="mt-4 md:w-3/4 md:text-lg text-textColor font-semibold">Leverage blockchain’s transformative power with Omronix’s end-to-end development and consulting services</p>
            ...
            <div className="right w-full flex justify-center relative bottom-10">
                <img src="/BlockchainImage/1.jpg" alt="" className="w-92 rounded-2xl"  />
            </div>
        </div>
  )
}
