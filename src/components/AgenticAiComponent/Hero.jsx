  ...
  return (
     <div className="HeroSection w-full min-h-screen flex flex-col-reverse md:flex-row justify-center items-center gap-10 md:mt-0 mt-12">
            <div className="left w-full md:p-10 p-4 relative bottom-10">
                ...
                <p className="mt-4 md:w-3/4 text-sm md:text-lg text-textColor font-semibold">Autonomous Intelligence for Smarter Operations . Deploy self-learning AI agents that act, adapt, and innovate independently. </p>
