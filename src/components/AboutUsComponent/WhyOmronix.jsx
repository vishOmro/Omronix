...
const WhyOmronix = () => {
  return (
    <div className="AboutSection w-full p-10 min-h-screen flex flex-col justify-center items-center relative  bg-blue-200">
        ...
        <div className="left w-full md:p-10 p-5 flex flex-col gap-14 ">
          <div className="choose_container max-w-3/4 flex gap-10">
            ...
            <div className="choose_content flex flex-col gap-2">
              ...
              <p className="text-sm text-textColor font-semibold text-right">GDPR, TCPA, and local regulatory adherence. Customer bussiness centric strategies </p>
            </div>
          </div>
          <div className="choose_container max-w-3/4 flex gap-10">
